...
/**
 * Hero section — large serif name,
 * one-line tagline, CTA buttons, and social links.
    ...
    >
      <div className="max-w-content mx-auto text-center">
        ...
        <ScrollReveal delay={0.16}>
          <p className="font-sans text-lg md:text-xl text-[var(--text-secondary)] max-w-xl mx-auto mb-10 leading-relaxed">
            {profile.tagline}
          </p>
        </ScrollReveal>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            ...
            <a
              ...
              className="glass-btn px-7 py-3 font-sans text-sm font-medium
                text-[var(--text-primary)] hover:text-white transition-colors duration-200"
