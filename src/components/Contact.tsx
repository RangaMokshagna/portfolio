...
export function Contact() {
  return (
    <section id="contact" className="px-6 py-24 md:py-32 min-h-[100svh] flex flex-col justify-center">
      <div className="max-w-content mx-auto">
        ...
        <ScrollReveal delay={0.1}>
          <GlassCard className="p-8 md:p-10 max-w-lg mx-auto" tilt={false}>
            <div className="space-y-6">
              {/* Email */}
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-white/10 dark:bg-white/[0.06] flex items-center justify-center shrink-0">
                  <svg
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-sm hover:text-accent-blue dark:hover:text-accent-blue-light transition-colors break-all"
              ...
              {/* Divider */}
              <hr className="border-white/10 dark:border-white/[0.06]" />
              ...
              <div className="flex items-center gap-4">
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-white/10 dark:bg-white/[0.06] flex items-center justify-center
