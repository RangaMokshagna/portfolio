...
/**
 * Contact section — glass card with email, location, and social links.
 */
    ...
    <section id="contact" className="px-6 pt-24 pb-12 flex flex-col justify-center min-h-[calc(100svh-80px)]">
      <div className="max-w-content mx-auto w-full">
        ...
        <ScrollReveal delay={0.1}>
          <GlassCard className="p-8 max-w-[700px] mx-auto w-full" tilt={false}>
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-xl bg-black/5 dark:bg-white/[0.06] flex items-center justify-center shrink-0">
                    <svg
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-sm hover:text-gray-900 dark:hover:text-white transition-colors break-all"
                      aria-label="Send email to jayavaramrangamokshagna@gmail.com"
                    >
                      jayavaramrangamokshagna@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-xs text-[var(--text-secondary)] mb-0.5">Location</p>
              ...
              <hr className="my-5 lg:my-0 lg:mx-8 border-t lg:border-t-0 lg:border-l border-black/10 dark:border-white/10 lg:h-20" />
              ...
              <div className="flex items-center gap-4">
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-black/5 dark:bg-white/[0.06] flex items-center justify-center
